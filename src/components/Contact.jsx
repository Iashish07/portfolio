...
const Contact = () => {
  return (
    <div id='contact' className='bg-linear-to-t from-[#0E2433] to-[#224C78] w-full md:min-h-[60vh] py-2'>
  ...
  <a
    ...
    className="px-6 py-3 bg-white text-black font-semibold rounded-full hover:bg-green-300 transition"
  >
    Connect Now
  </a>
</div>
